...
final class FSCameraView: UIView, UIGestureRecognizerDelegate {
    ...
    func initialize() {
        ...
        flashButton.tintColor = fusumaTintColor //UIColor.hex("#555555", alpha: 1.0)
        flipButton.tintColor  = fusumaTintColor //UIColor.hex("#555555", alpha: 1.0)
        shotButton.tintColor  = fusumaTintColor //UIColor.hex("#2B2B2B", alpha: 1.0)
